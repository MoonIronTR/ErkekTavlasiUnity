...
{
    public PointStack[] Points { get; private set; }
    public PlayerColor CurrentPlayer { get; set; }
    public List<int> DiceRemaining { get; private set; }
    public int WhiteBar { get; set; }
    public int BlackBar { get; set; }
    public int WhiteOff { get; set; }
    public int BlackOff { get; set; }
    ...
    public List<BackgammonMove> GetLegalMoves()
    {
        ...
        {
            int die = DiceRemaining[i];
            AddLegalMovesForDie(moves, die);
        }
    ...
    {
        int barCount = GetBarCount(CurrentPlayer);
    ...
    private int GetTargetPoint(int fromPoint, int die)
    {
        ...
        if (CurrentPlayer == PlayerColor.White)
        {
            ...
            return target < 0 ? BackgammonMove.ToOffBoard : target;
        }

        int blackTarget = fromPoint + die;
        return blackTarget > 23 ? BackgammonMove.ToOffBoard : blackTarget;
    }
